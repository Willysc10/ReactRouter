...
#[derive(Debug)]
pub struct ReactRouterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ReactRouterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ReactRouter processing");
    
    let mut processor = ReactRouterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ReactRouterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ReactRouterProcessor::new(false);
